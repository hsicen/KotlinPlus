...
public class PageView extends View {
    ...
    public void initPath() {
        ...
        // 贝塞尔曲线绘制
        ValueAnimator animHead = ValueAnimator.ofObject(new ViewPathEvaluator(), viewPath.getPoints().toArray());
        ...
        ValueAnimator animEar1 = ValueAnimator.ofObject(new ViewPathEvaluator(), viewPathEar1.getPoints().toArray());
        ...
        ValueAnimator animEar2 = ValueAnimator.ofObject(new ViewPathEvaluator(), viewPathEar2.getPoints().toArray());
        ...
        ValueAnimator animBody = ValueAnimator.ofObject(new ViewPathEvaluator(), viewPathBody.getPoints().toArray());
        ...
        ValueAnimator animArmRight = ValueAnimator.ofObject(new ViewPathEvaluator(), viewPathArmRight.getPoints().toArray());
        ...
        ValueAnimator animHandRight = ValueAnimator.ofObject(new ViewPathEvaluator(), viewPathHandRight.getPoints().toArray());
        ...
        ValueAnimator animArmLeft = ValueAnimator.ofObject(new ViewPathEvaluator(), viewPathArmLeft.getPoints().toArray());
        ...
        ValueAnimator animHandLeft = ValueAnimator.ofObject(new ViewPathEvaluator(), viewPathHandLeft.getPoints().toArray());
        ...
        ValueAnimator animTail = ValueAnimator.ofObject(new ViewPathEvaluator(), viewPathTail.getPoints().toArray());
